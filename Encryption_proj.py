...
class AESEncryption(object):
    ...
    def encrypt_aes(self, data_to_encrypt, key):
        encryption_cipher = AES.new(key)  # Encryption & decryption cipher objects
